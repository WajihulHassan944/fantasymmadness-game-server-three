Warning: truncated output (original token count: 270801)
... 34625 bytes omitted ...
...
app.post('/register', submitLimiter, async (req, res) => {
  try {
    // Deliberately not logging req.body: it carries the plaintext pas…122152 tokens truncated…otTarget, pot: spec.potTarget } : {}),
