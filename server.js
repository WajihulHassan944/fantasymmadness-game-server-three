Warning: truncated output (original token count: 271597)
... 37809 bytes omitted ...
...
// POST API to update match reward status by m…202152 tokens truncated…ftClosesAt: { $lte: now } },
      { $set: { status: 'RUNNING' } },
    );
...
// Full Card Promoter is registered as an isolated event-container module. It
// reuses Match, Score and the classic scoring function rather than creating a
// second game engine.
require('./full-card-promoter')({
  ...
  verifyAdminToken,
  requireScope,
  affiliateScope: TOKEN_SCOPES.AFFILIATE,
  playerScope: TOKEN_SCOPES.PLAYER,
