...
(() => {
  ...
  [
    ...
    if (!configured) console.warn(`WARNING: ${name} is not set â€” ${effect}.`);
  });
})();
...
,
    ...
    mailOptions.subject = `${savedMatch.matchFighterA} vs ${savedMatch.matchFighterB} â€” New FANTASY MMADNESS Fight`;
    mailOptions.html = `
      <div style="margin:0;padding:24px 10px;background:#05070b;color:#fff;font-family:Arial,sans-serif;">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;max-width:620px;margin:auto;background:#0b1018;border:1px solid #293243;border-radius:22px;overflow:hidden;box-shadow:0 18px 48px rgba(0,0,0,.5);">
          ...
          <tr><td align="center" style="padding:20px 24px 28px;border-top:1px solid #263142;">
            <p style="margin:0 0 18px;color:#c7cfda;font-size:14px;"><strong style="color:#fff;">${escapeHtml(String(savedMatch.matchDate || '').slice(0, 10))}</strong> &nbsp;â€¢&nbsp; ${escapeHtml(savedMatch.matchTime || 'Time TBA')} &nbsp;â€¢&nbsp; ${Number(savedMatch.maxRounds || 0)} rounds</p>
            <a href="https://fantasymmadness.com/upcomingfights" style="display:inline-block;padding:14px 28px;border-radius:999px;background:linear-gradient(90deg,#ef1d31,#ff3d4e);color:#fff;font-size:14px;font-weight:900;text-decoration:none;">OPEN THE FIGHT CARD â†’</a>
          </td></tr>
          <tr><td align="center" style="padding:17px;background:#070a10;"><p style="margin:0;color:#738096;font-size:11px;letter-spacing:1px;">PREDICT â€¢ SCORE â€¢ CLIMB</p><p style="margin:8px 0 0;"><a href="https://fantasymmadness.com" style="color:#f7b51b;text-decoration:none;font-weight:800;">FANTASYMMADNESS.COM</a></p></td></tr>
        </table>
      </div>`;
    return mailOptions;
  });
